...
/**
 * Komponente f&uuml;r das Tag <code>&lt;suche-kunde-by-bestellungId&gt;</code>,
 * die aus den
 ...
 */
@Component({
    selector: 'suche-kunde-by-bestellungId',
...
export default class SucheKundebyBestellungId implements OnDestroy {
    waiting: boolean = false;

    constructor() { console.log('SucheKundebyBestellungId.constructor()'); }
    ...
    ngOnDestroy(): void { console.log('SucheKundebyBestellungId.onDestroy()'); }
    ...
    toString(): String { return 'SucheKundebyBestellungId'; }
}
