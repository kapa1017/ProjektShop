...
/**
 * Komponente f&uuml;r das Tag <code>&lt;suche-kunden&gt;</code>, die aus den
...
export default class SucheKunden implements OnDestroy {
    waiting: boolean = false;

    constructor() { console.log('SucheKunden.constructor()'); }
    ...
    ngOnDestroy(): void { console.log('SucheKunden.onDestroy()'); }
    ...
    toString(): String { return 'SucheKunden'; }
}
